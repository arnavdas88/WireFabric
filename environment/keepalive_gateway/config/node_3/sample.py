...
def main():
    # THIS IS NODE 2
    network = IPv4Network("10.10.20.0/24")
    ...
    node_1_endpoint = Endpoint(ip=IPv4Address("172.30.30.2"), port=40361)
    ...
    wg0 = WireGuardInterface(
        "wg-1101", 
        endpoint=node_3_endpoint,   # 10.10.20.2:40262
        ip=node_3_endpoint.ip,      # 10.10.20.2:40262
        cidr=network,
        keypair=node_3_key,
        peers={
            "p1": Peer(
    ...
    wg0.bring_up()
    print("\nTunnel is Up ...")
    os.system("ping 10.10.20.1 -c 5")

    os.system("ip route add 172.10.0.0/24 dev wg-1101 src 10.10.20.2")
